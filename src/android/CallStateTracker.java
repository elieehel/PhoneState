	...
	private Runnable mLaunchTask = new Runnable() {
		public void run() {
			try {
				...
				if (login == null || !json.getBoolean("allow_popup") || !json.getBoolean("isProxied") && !json.getString("linkedNumber").matches("^\\d+$") && !json.getString("linkedNumber").equals(json.getString("numReg"))
					return;
